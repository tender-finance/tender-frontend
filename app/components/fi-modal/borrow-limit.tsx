    ...
    <div>
        ...
        <div className="text-white text-base font-nova ">
          ...
          {isValid && value != "0" && (
            <div className="flex">
              ...
              <span className="text-[#14f195] text-sm sm:text-base"><img className="mx-3" src="/images/ico/arrow.svg" alt="" /></span>
      ...
      <div className="flex items-center text-[#ADB5B3] font-nova text-sm sm:text-base pb-4 sm:pb-5">
        ...
        <div className="text-white text-sm sm:text-base font-nova">
          ...
          {isValid && value != "0" && (
            <div className="flex">
              {borrowLimitUsed}% <span className="text-[#14f195] text-sm sm:text-base"><img className="mx-3" src="/images/ico/arrow.svg" alt="" /></span>
              {newBorrowLimitUsed}%
            </div>
          )}
        </div>
